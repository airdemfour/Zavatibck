...
abstract class ZController extends Zedek{
	...
	function __construct(){
		$this->uri = new ZURI;
		$this->app = new App;
		if (($this->uri->controller == "default") and ($this->uri->method == "index")) {
		} elseif($this->uri->controller == "default" && $this->uri->method == "login"){
		} elseif($this->uri->controller == "service"){
		} else {
			$this->checklogin();
		}
	}
	...
	public function index(){
		self::display("404@ztheme", array(), "default");
	} 
